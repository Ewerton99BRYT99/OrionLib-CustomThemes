...
## Booting the Ui Library
```lua
local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/Ewerton99BRYT99/OrionLib-CustomThemes/refs/heads/main/OrionLibCustomThemes.txt')))()
```



## Creating a Window | Custom Themes Are: Default , Blood , Light , Darker , Grape , Sentinel , Synapse , Ocean , Banana , Midnight
```lua
local Window = OrionLib:MakeWindow({Name = "Title of the library", HidePremium = false, SaveConfig = true, SelectedTheme = "Default", ConfigFolder = "OrionTest"})
...
SelectedTheme = "Default" - There Are Custom Themes Here The Custom Themes: Light , Darker , Blood , Grape , Sentinel , Synapse , Ocean , Midnight , Banana
